...
model = dict(
    type="MapPP",
    pretrained='work_dirs/nusc_centerpoint_pp_02voxel_circle_nms/last.pth', # this is their fully trained model
    reader=dict(
    ...
    bbox_head=dict(
        ...
        type="CenterHead",
        mode="3d",
        in_channels=sum([128, 128, 128, 3]), # We assume that our map will add 64 channels containing map features with same shape (128x128) as the RPN output
        norm_cfg=norm_cfg,
        tasks=tasks,
        dataset='nuscenes',
        weight=0.25,
