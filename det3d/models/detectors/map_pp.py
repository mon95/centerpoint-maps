...
class MapPP(BaseDetector):
    ...
    def forward(self, example, return_loss=True, **kwargs):
        ...
        mapdata = example['rasterized_map']  # img tensor 
        ...
        x = torch.cat([x, map_feat], dim=1)  # tianwei had used dim = 1;PP output dims = [4, 384, 128, 128],  VERIFY
    ...
    def freeze(self):
        ...
        # Problem is that this requires pytorch v>1.4 whereas CenterPoint installs 1.1
